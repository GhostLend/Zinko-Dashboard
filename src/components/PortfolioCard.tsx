...
const PortfolioCard = () => {
  return <div className="glass-card p-6 rounded-lg mb-8 animate-fade-in">
      ...
      <div className="grid grid-cols-3 gap-4 mb-6 rounded-none">
        <div className="text-center p-4 rounded-lg bg-gradient-to-br from-success/10 to-success/5">
          <p className="text-muted-foreground mb-1 text-xs">Total Lent</p>
          <p className="font-bold text-success text-sm">$512K</p>
        </div>
        <div className="text-center p-4 rounded-lg bg-gradient-to-br from-warning/10 to-warning/5">
          <p className="text-muted-foreground mb-1 text-xs">Total Borrowed</p>
          <p className="font-bold text-warning text-sm">$325K</p>
        </div>
        <div className="text-center p-4 rounded-lg bg-gradient-to-br from-primary/10 to-primary/5">
          ...
          <p className="font-bold text-primary text-sm">$580K</p>
        </div>
      </div>
      ...
      <div className="w-full h-[240px]">
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={positionData}>
            ...
            <YAxis stroke="#475569" fontSize={12} tickFormatter={value => `$${value}K`} />
